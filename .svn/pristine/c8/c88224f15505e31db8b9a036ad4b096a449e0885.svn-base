...
<div class="row">
    <div class="col-md-12">
        <div class="table-header">
            <g:message code="loan.loanRequestedList.table.header" default="List of Loan Requests"/>
        ...
        <div class="table-responsive">
            <table id="loanTable" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th class="center">
                        <g:message code="loan.loanApplication.label.accName" default="Account Holder Name"/></th>
                    <th class="center">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('#loanTable').on('click', 'a.approve-reference', function (e){
            var control = this;
            var referenceId = $(control).attr('referenceId');
            jQuery.ajax({
                type: 'POST',
                url: "${g.createLink(controller: 'loan',action: 'approveRequest')}?id=" + referenceId,
