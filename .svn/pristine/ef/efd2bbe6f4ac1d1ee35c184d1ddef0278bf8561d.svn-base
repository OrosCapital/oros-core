...
<div class="col-xs-12">
                ...
                <div class="col-sm-8 col-xs-12">
                    <div class="clearfix">
                        <select id="vat" class="col-sm-11 col-xs-12" name="vat">
                            ...
                            <g:each in="${VatCategory.list()}">
                                <option value="${it?.id}">${it.name}(${it.rate})</option>
                            </g:each>
                        </select>
                    </div>
                </div>
    ...
    <div class="tab-pane" id="vendorGeneralAddress">
        <g:render template='/coreBanking/settings/accounting/vendor/generalAddress'/>
    </div>
    <div class="tab-pane" id="vendorPostalAddress">
        <g:render template='/coreBanking/settings/accounting/vendor/postalAddress'/>
    </div>
    <div class="tab-pane" id="vendorBankAccountInfo">
        <g:render template='/coreBanking/settings/accounting/vendor/bankAccount'/>
    </div>
    </div>
</div>
